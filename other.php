...
<nav class="navbar">
    ...
    <div class="banner">
        <img src="11171eb9984b49d5a01d3bbb81d5fe92.png">
    </div>
    <div class="about">
        <div class="content">
            <div class="title">Any question not matching with 1st six options can be asked here</div>
        </div>
    </div>
