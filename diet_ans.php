...
$sql = "SELECT * FROM questions where topic = 'diet'";
                                 ...
                                 <li>
                                    <div class="timeline-content">
                                        <form action="answer.php" method="post">
                                          <h2> Question : </h2>
                                          <h3><?php echo $row['question']; ?></h3><br><br>
                                          <h3> Enter the Answer :</h3>
                                          <input type="text" name="answer" placeholder="Wrtie the Answer... " required><br><br>
                                          <input type="checkbox" name="question" id="1" value="<?php echo $row['question']; ?>" required> <label for="1"> Are you sure ? </label><br>
